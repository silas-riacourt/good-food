...
export const reducers = combineReducers({
  ...
  projects: require('../../modules/entities/project/project.reducer').reducer,
  labels: require('../../modules/entities/label/label.reducer').reducer,
  tickets: require('../../modules/entities/ticket/ticket.reducer').reducer,
  attachments: require('../../modules/entities/attachment/attachment.reducer').reducer,
  comments: require('../../modules/entities/comment/comment.reducer').reducer,

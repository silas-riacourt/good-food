...
import fr.cesi.cube.repository.IngredientRepository;
...
class IngredientResourceIT {
    ...
    public static Ingredient createEntity(EntityManager em) {
        Ingredient ingredient = new Ingredient().label(DEFAULT_LABEL);
        return ingredient;
    }
    ...
    public static Ingredient createUpdatedEntity(EntityManager em) {
        Ingredient ingredient = new Ingredient().label(UPDATED_LABEL);
        return ingredient;
    }
    ...
    void createIngredient() throws Exception {
        ...
        assertThat(testIngredient.getLabel()).isEqualTo(DEFAULT_LABEL);
    }
    ...
    void putNewIngredient() throws Exception {
        ...
        updatedIngredient.label(UPDATED_LABEL);
        ...
        Ingredient testIngredient = ingredientList.get(ingredientList.size() - 1);
        assertThat(testIngredient.getLabel()).isEqualTo(UPDATED_LABEL);
    }
    ...
    void partialUpdateIngredientWithPatch() throws Exception {
        ...
        partialUpdatedIngredient.label(UPDATED_LABEL);

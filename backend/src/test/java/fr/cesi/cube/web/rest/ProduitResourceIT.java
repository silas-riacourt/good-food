...
class ProduitResourceIT {
    ...
    public static Produit createEntity(EntityManager em) {
        Produit produit = new Produit().nom(DEFAULT_NOM).prix(DEFAULT_PRIX).description(DEFAULT_DESCRIPTION).image(DEFAULT_IMAGE);
        return produit;
    }
    ...
    public static Produit createUpdatedEntity(EntityManager em) {
        Produit produit = new Produit().nom(UPDATED_NOM).prix(UPDATED_PRIX).description(UPDATED_DESCRIPTION).image(UPDATED_IMAGE);
        return produit;
    }
    ...
    void putNewProduit() throws Exception {
        ...
        updatedProduit.nom(UPDATED_NOM).prix(UPDATED_PRIX).description(UPDATED_DESCRIPTION).image(UPDATED_IMAGE);
    ...
    void partialUpdateProduitWithPatch() throws Exception {
        ...
        partialUpdatedProduit.description(UPDATED_DESCRIPTION).image(UPDATED_IMAGE);
    ...
    void fullUpdateProduitWithPatch() throws Exception {
        ...
        partialUpdatedProduit.nom(UPDATED_NOM).prix(UPDATED_PRIX).description(UPDATED_DESCRIPTION).image(UPDATED_IMAGE);
